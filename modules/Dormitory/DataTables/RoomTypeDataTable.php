...
class RoomTypeDataTable extends DataTable
{
        ...
        ->editColumn('status', function ($row) {
            ...
            ->addColumn('action', function ($query) {
                return '<a href="#" class="btn btn-primary-soft btn-sm me-1" onclick="showEditModal('.$query->id.')" title="Edit"><i class="fa fa-edit"></i></a>'.
                    '<a href="#" class="btn btn-danger-soft btn-sm" onclick="delete_modal(\''.route(config('theme.rprefix').'.destroy', $query->id).'\',\'room-type-table\')"  title="Delete"><i class="fa fa-trash"></i></a>';
            })
            ->setRowId('id')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('room_type')->title(__('Room type'))->defaultContent('N/A'),
