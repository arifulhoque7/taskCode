...
class UserDataTable extends DataTable
{
    ...
    public function getColumns() : array
    {
        return [
            ...
            Column::computed('membership')->title(__('Membership'))->orderable(false)->searchable(false),
            Column::make('notification')->title(__('Notification'))->defaultContent('N/A')->orderable(false)->searchable(false),
