        ...
        <nav class="sidebar-nav">
            <ul class="metismenu">
                <ul class="metismenu">
                    ...
                    <x-admin.nav-title title="Post Managment" />
                    <x-admin.multi-nav>
                        <x-slot name="title">
                            <i class="fa-regular fa-clipboard"></i> {{ __('Manage Post') }}
                        </x-slot>
                        {{-- @if (module_active('dormitory')&& can('room_type_management')) --}}
                        <x-admin.nav-link href="{{ route('posts.index') }}">
                            {{ __('All Post') }}
                        </x-admin.nav-link>
                        {{-- @endif --}}
